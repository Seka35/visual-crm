                ...
                <div className="max-h-[300px] overflow-y-auto space-y-1">
                    {notifications.length === 0 ? (
                        ...
                        notifications.map(notification => (
                            <div
                                key={notification.id}
                                className={`p-3 rounded-xl transition-colors ${notification.read ? 'bg-white dark:bg-slate-900' : 'bg-slate-50 dark:bg-slate-800'}`}
                            >
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm text-slate-700 dark:text-slate-200 leading-snug">{notification.content}</p>
