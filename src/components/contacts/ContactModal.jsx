        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl relative z-10 animate-in zoom-in-95 duration-200">
                <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                    <h3 className="text-xl font-bold text-slate-800">{isEditing ? 'Edit Contact' : 'Add New Contact'}</h3>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-bold text-slate-700 mb-2">Company & Role</label>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="relative">
