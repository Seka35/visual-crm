                ...
                <div className="flex items-center gap-4 flex-1 max-w-xl">
                    <div className="relative w-full group hidden sm:block">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 bg-slate-100/50 border-none rounded-xl focus:ring-2 focus:ring-primary/20 focus:bg-white transition-all outline-none text-slate-600 placeholder:text-slate-400"
                        />
                    </div>
                ...
                <div className="flex items-center gap-2 sm:gap-6">
                    ...
                    <div className="relative hidden md:block">
                        <button
                            ...
                            className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 hover:bg-slate-100 rounded-lg border border-slate-100 transition-colors"
                        >
                        ...
                        {isWorkflowOpen && (
                            <>
                                ...
                                <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl border border-slate-100 p-1 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                    <div className="p-2">
                                        ...
                                        >
                                            <span className={!currentWorkflow ? 'font-bold text-primary' : 'text-slate-600'}>Personal Workspace</span>
                                        ...
                                        {workflows.map(wf => (
                                            <div key={wf.id} className="flex items-center group">
                                                <button
                                                    ...
                                                    className="flex-1 flex items-center justify-between px-3 py-2 rounded-lg text-sm hover:bg-slate-50 transition-colors text-left"
                                                >
                                                    <span className={currentWorkflow?.id === wf.id ? 'font-bold text-primary' : 'text-slate-600'}>{wf.name}</span>
                    ...
                    <div className="relative">
                        ...
                        {isProfileOpen && (
                            <>
                                ...
                                />
                                <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-xl border border-slate-100 p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                    ...
                                    <div className="space-y-1">
                                        <button
                                            ...
                                            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-primary transition-colors"
                                        >
                                        ...
                                        <button className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-primary transition-colors">
                                            <Settings className="w-4 h-4" />
                                            <span>Account Settings</span>
                                        </button>
                                        <button
                                            onClick={toggleTheme}
                                            className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-primary transition-colors"
                                        >
