        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 p-4 sm:p-8">
            ...
            <div className="flex border-b border-slate-200">
                <button
                    ...
                    className={`px-6 py-3 text-sm font-medium transition-colors relative ${activeTab === 'profile' ? 'text-primary' : 'text-slate-500 hover:text-slate-700'
                        }`}
                >
                    Profile Details
                    {activeTab === 'profile' && (
                ...
                <button
                    ...
                    className={`px-6 py-3 text-sm font-medium transition-colors relative ${activeTab === 'workflows' ? 'text-primary' : 'text-slate-500 hover:text-slate-700'
                        }`}
                >
                    Workflows
                    {activeTab === 'workflows' && (
            ...
            {activeTab === 'profile' && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col items-center text-center h-full">
                            <div className="relative mb-4 group">
                                <div className="w-32 h-32 rounded-full p-1 border-2 border-slate-100">
                                    <img
                                        src={avatarUrl}
                                        alt="Profile"
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-blue-200 transition-colors group">
                                    ...
                                    <p className="text-slate-700 font-medium truncate" title={email}>{email}</p>
                                </div>

                                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-purple-200 transition-colors group">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="p-2 bg-white rounded-lg shadow-sm text-purple-500 group-hover:text-purple-600">
                                            <Shield className="w-4 h-4" />
                                        </div>
                                        <span className="text-xs font-semibold text-slate-400 uppercase">User ID</span>
                                    </div>
                                    <p className="text-slate-700 font-medium font-mono text-xs truncate" title={user.id}>{user.id}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-green-200 transition-colors group">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="p-2 bg-white rounded-lg shadow-sm text-green-500 group-hover:text-green-600">
                                            <Calendar className="w-4 h-4" />
                                        </div>
                                        <span className="text-xs font-semibold text-slate-400 uppercase">Last Sign In</span>
                                    </div>
                                    <p className="text-slate-700 font-medium">{lastSignIn}</p>
                                </div>

                                <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-orange-200 transition-colors group">
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="p-2 bg-white rounded-lg shadow-sm text-orange-500 group-hover:text-orange-600">
                                            <Shield className="w-4 h-4" />
                                        </div>
