-- Use POST request with query params and NULL body
-- This avoids JSON parsing issues AND body-override-header issues.
...
BEGIN
    -- Log start
    INSERT INTO public.debug_logs (function_name, message) VALUES ('process_reminders', 'Function started (POST+Params Version)');
