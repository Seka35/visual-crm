-- Update process_reminders to avoid double notifications
...
BEGIN
    -- Log start
    INSERT INTO public.debug_logs (function_name, message) VALUES ('process_reminders', 'Function started (No Double Notifications Version)');
