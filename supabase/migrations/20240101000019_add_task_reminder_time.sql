-- Add reminder_time to tasks
ALTER TABLE public.tasks ADD COLUMN IF NOT EXISTS reminder_time TIME DEFAULT '09:00:00';

-- Update process_reminders to use reminder_time for tasks
...
BEGIN
    -- Log start
    INSERT INTO public.debug_logs (function_name, message) VALUES ('process_reminders', 'Function started (Task Time Version)');
