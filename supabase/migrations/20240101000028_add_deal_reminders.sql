-- Add reminder columns to deals
ALTER TABLE public.deals ADD COLUMN IF NOT EXISTS reminder_date DATE;
ALTER TABLE public.deals ADD COLUMN IF NOT EXISTS reminder_time TIME DEFAULT '09:00:00';
ALTER TABLE public.deals ADD COLUMN IF NOT EXISTS reminder_sent BOOLEAN DEFAULT FALSE;

-- Update process_reminders to handle deals
...
BEGIN
    -- Log start
    INSERT INTO public.debug_logs (function_name, message) VALUES ('process_reminders', 'Function started (Deals Version)');
